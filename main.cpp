...
int main()
{
    ...
    cout << "Welcome! This game is a twist on the super-popular internet sensation " <<
        ...
        "- Letters not in the word are marked with a " << BACKGROUND(BackgroundColor::Grey, FOREGROUND(ForegroundColor::Black, "GREY BACKGROUND")) << endl <<
        "- Letters in the word but are in the wrong positions are marked with a " << BACKGROUND(BackgroundColor::Yellow, FOREGROUND(ForegroundColor::Black, "YELLOW BACKGROUND")) << endl <<
        "- Letters in the word AND are in the right positions are marked with a " << BACKGROUND(BackgroundColor::Green, FOREGROUND(ForegroundColor::Black, "GREEN BACKGROUND")) << endl << endl; 
